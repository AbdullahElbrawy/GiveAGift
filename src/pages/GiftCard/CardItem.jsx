	...
	return (
        ...
        {`
          @media (max-width: 400px) {
            .card {
             max-width: 300px;margin:auto ;width: 100%;
        ...
        `}
			...
			<div className="rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 bg-white card" >
			<div className="relative group flex justify-center md:h-[240px] h-[180px] card-img" style={{ margin:'auto' }}>
