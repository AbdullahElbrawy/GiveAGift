...
export default function CardPreview({ cardSitting, back, ShowBrand }) {
  ...
  return (
    <div className="sm:min-w-[280px]  lg:w-[450px]   w-full xs:mb-10 md:mb-3">
      <figure
        ...
        style={{ backgroundColor: cardSitting.color , maxWidth: "480px" }}
      >
        <div
          className={"   lg:w-[450px] mx-auto  sm:min-w-[280px]   md:h-[240px]    h-[180px] "}
          style={{ position: "relative", maxWidth: "480px" }}
        >
          {!back ? (
            <>
              <div className="absolute sm:min-w-[280px]  mx-auto  ">
                {cardSitting.shape ? (
                  <img
                    src={cardSitting.shape}
                    height={200}
                    alt="gift card"
                    className="rounded-2xl  object-fill mx-auto  sm:min-w-[280px]    lg:w-[450px]     md:h-[240px]   h-[180px]  object-fill absolute  transition duration-500 group-hover:opacity-0 group-hover:scale-75 z-10"
                  />
                ) : null}
              </div>
