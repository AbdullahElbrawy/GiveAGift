...
export default function CardPreview({ cardSitting, back, ShowBrand }) {
  ...
  return (
    <div className="max-w-[450px] min-w-[270px] xs:min-w-[350px]  sm:w-[450px]   justify-center flex    h-[220px] mx-auto md:mb-3 xs:mb-10 md:mb-3">
      <figure
      ...
      >
        ...
        >
          {!back ? (
            <>
              <div className="absolute  max-w-[480px] min-w-[270px]    h-[220px]  mx-auto  ">
                {cardSitting.shape ? (
                  <img
                    src={cardSitting.shape}
                    height={200}
                    alt="gift card"
                    className="rounded-2xl  object-fill mx-auto  w-full h-[220px]  object-fill absolute  transition duration-500 group-hover:opacity-0 group-hover:scale-75 z-10"
                  />
                ) : null}
              </div>
