              ...
              <div className="absolute max-w-[450px]  min-w-[270px]  sm:w-[450px]  h-[220px]   mx-auto  ">
                {cardSitting.shape ? (
                  <img
                    ...
                    height={200}
                    alt="gift card"
                    className="rounded-2xl  object-fill mx-auto max-w-[450px]  min-w-[270px]  sm:w-[450px]   h-[220px]   absolute  transition duration-500 group-hover:opacity-0 group-hover:scale-75 z-10"
                  />
                ) : null}
              </div>
