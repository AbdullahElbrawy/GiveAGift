...
export default function CardPreview({ cardSitting, back, ShowBrand }) {
  ...
  return (
    <div className="min-w-[270px] justify-center flex  max-w-[480px]  h-[200px] mx-auto md:mb-3 xs:mb-10 md:mb-3">
      <figure
              ...
              <div className={`absolute top-2 mix-blend-screen   right-2 z-10`}>
                {cardSitting.brand.logoName ? (
                  <img
                    ...
                    width={65}
                    height={65}
                    className="rounded-full object-fill  bg-white  transition duration-500 group-hover:opacity-0 group-hover:scale-75 z-10"
                  />
                ) : null}
              </div>
            </>
