              ...
              <div className="absolute   sm:min-w-[280px] mx-auto     lg:w-[450px]     md:h-[240px]   h-[180px] ">
                {cardSitting.shape ? (
                  <img
                    ...
                    height={200}
                    alt="gift card"
                    className="rounded-2xl sm:min-w-[280px] object-cover mx-auto  w-full   lg:w-[450px]     md:h-[240px]   h-[180px]  object-cover absolute  transition duration-500 group-hover:opacity-0 group-hover:scale-75 z-10"
                  />
                ) : null}
              </div>
